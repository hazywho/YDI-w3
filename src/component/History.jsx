...
const PostCanva = () => (
  <section id = "history" className="bg-black pb-52">
    <div className="container mx-auto px-3 md:px-10">
      <div className="px-5 py-32">
        <p className="font-circular-web text-lg text-blue-50">
          THE AUSTRIA<b>N</b> PRINCESS
        </p>
        <p className="max-w-md font-circular-web text-lg text-blue-50 opacity-50">
          Born Maria Antonia, the fifteenth child of Empress Maria Theresa, she arrived in France as a dauphine at just fourteen. 
          Her marriage to the future Louis XVI forged a powerful alliance, yet cast her into a complex, unfamiliar world.
        </p>
      </div>
